...
( function () {
	...
	function JVSmoothScroll( opts=false ) {
		...
		options.header.height = window.jvss.header.height = getHeight( options.header.elem ) || 0;
		...
		if ( options.prevent ) preventLinks = document.querySelectorAll( options.prevent );
