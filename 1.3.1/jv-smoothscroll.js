...
( function () {
	...
	function JVSmoothScroll( opts=false ) {
		...
		let selector = options.container + ' ' + options.selector + ( options.exclude && ':not(' + options.exclude + '' );

		if ( options.ignoreNg ) selector = selector + ',' + options.container + ' ' + options.ngSelector;
